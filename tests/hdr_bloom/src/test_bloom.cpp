...
void testBloom()
{
	...
	ShaderProgram hdrFBOShader({
		VertexShader::loadFromFile("tests/hdr_bloom/shaders/bloom_hdrFBO.vert").getHandler(),
		FragmentShader::loadFromFile("tests/hdr_bloom/shaders/bloom_hdrFBO.frag").getHandler(),
	});
	ShaderProgram cubeLightShader({
		VertexShader::loadFromFile("tests/hdr_bloom/shaders/cube_light.vert").getHandler(),
		FragmentShader::loadFromFile("tests/hdr_bloom/shaders/cube_light.frag").getHandler(),
	});
	ShaderProgram blurHShader({
		VertexShader::loadFromFile("tests/hdr_bloom/shaders/bloom_blur.vert").getHandler(),
		FragmentShader::loadFromFile("tests/hdr_bloom/shaders/bloom_blur_GS_horizontal.frag").getHandler(),
	});
	ShaderProgram blurVShader({
		VertexShader::loadFromFile("tests/hdr_bloom/shaders/bloom_blur.vert").getHandler(),
		FragmentShader::loadFromFile("tests/hdr_bloom/shaders/bloom_blur_GS_vertical.frag").getHandler(),
	});
	ShaderProgram finalShader({
		VertexShader::loadFromFile("tests/hdr_bloom/shaders/bloom_final.vert").getHandler(),
		FragmentShader::loadFromFile("tests/hdr_bloom/shaders/bloom_final.frag").getHandler(),
	});
