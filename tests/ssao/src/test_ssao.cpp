...
void test_ssao()
{
	...
	ShaderProgram gBufferShader({
		VertexShader::loadFromFile("tests/ssao/shaders/g_buffer.vert").getHandler(),
		FragmentShader::loadFromFile("tests/ssao/shaders/g_buffer.frag").getHandler()
	});
	ShaderProgram ssaoShader({
		VertexShader::loadFromFile("tests/ssao/shaders/ssao.vert").getHandler(),
		FragmentShader::loadFromFile("tests/ssao/shaders/ssao.frag").getHandler()
	});
	ShaderProgram blurShader({
		VertexShader::loadFromFile("tests/ssao/shaders/blur.vert").getHandler(),
		FragmentShader::loadFromFile("tests/ssao/shaders/blur.frag").getHandler()
	});
	ShaderProgram lightingShader({
		VertexShader::loadFromFile("tests/ssao/shaders/lighting.vert").getHandler(),
		FragmentShader::loadFromFile("tests/ssao/shaders/lighting.frag").getHandler()
	});
