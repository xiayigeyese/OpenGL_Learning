...
void testShadowMapPointLight()
{
	...
	ShaderProgram shadowShader({
		VertexShader::loadFromFile("tests/shadowMap/shaders/pointLight_shadow_depthMap.vert").getHandler(),
		GeometryShader::loadFromFile("tests/shadowMap/shaders/pointLight_shadow_depthMap.geom").getHandler(),
		FragmentShader::loadFromFile("tests/shadowMap/shaders/pointLight_shadow_depthMap.frag").getHandler()
	});
	...
	ShaderProgram worldShader({
		VertexShader::loadFromFile("tests/shadowMap/shaders/pointLight_shadow.vert").getHandler(),
		FragmentShader::loadFromFile("tests/shadowMap/shaders/pointLight_shadow.frag").getHandler()
	});
