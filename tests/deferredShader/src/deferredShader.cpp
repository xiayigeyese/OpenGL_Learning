...
void testDeferredShader()
{
	...
	ShaderProgram gBufferShader({
		VertexShader::loadFromFile("tests/deferredShader/shaders/g_buffer.vert").getHandler(),
		FragmentShader::loadFromFile("tests/deferredShader/shaders/g_buffer.frag").getHandler()
	});
	ShaderProgram deferredLigthShader({
		VertexShader::loadFromFile("tests/deferredShader/shaders/deferred_light.vert").getHandler(),
		FragmentShader::loadFromFile("tests/deferredShader/shaders/deferred_light.frag").getHandler()
	});
	ShaderProgram cubeLightShader({
		VertexShader::loadFromFile("tests/deferredShader/shaders/cube_light.vert").getHandler(),
		FragmentShader::loadFromFile("tests/deferredShader/shaders/cube_light.frag").getHandler()
	});
	ShaderProgram finalShader({
		VertexShader::loadFromFile("tests/deferredShader/shaders/final.vert").getHandler(),
		FragmentShader::loadFromFile("tests/deferredShader/shaders/final.frag").getHandler()
	});
