...
void test_hdr()
{
	...
	ShaderProgram hdrFboShader({
		VertexShader::loadFromFile("tests/hdr_bloomTest/shaders/hdr_fbo.vert").getHandler(),
		FragmentShader::loadFromFile("tests/hdr_bloomTest/shaders/hdr_fbo.frag").getHandler()
	});
	ShaderProgram hdrMappintShader({
		VertexShader::loadFromFile("tests/hdr_bloomTest/shaders/hdr_toneMapping.vert").getHandler(),
		FragmentShader::loadFromFile("tests/hdr_bloomTest/shaders/hdr_toneMapping.frag").getHandler()
	});
