...
void test_diffuse()
{
	...
	for (int i = 0; i < 6; i++)
	{
		envCubeMapFBO.attachCubeMapFace(GL_COLOR_ATTACHMENT0, *(envCubeMapFBOColor.get()), i);
	...
	for (int i = 0; i < 6; i++)
	{
		irradianceMapFBO.attachCubeMapFace(GL_COLOR_ATTACHMENT0, *(irradianceMapFBOColor.get()), i);
