...
int main()
{
	...
	ShaderProgram quadShader({
		VertexShader::loadFromFile("tests/csLearn/shaders/quad.vert").getHandler(),
		FragmentShader::loadFromFile("tests/csLearn/shaders/quad.frag").getHandler()
	});
	ShaderProgram rayTraceShader({
		ComputerShader::loadFromFile("tests/csLearn/shaders/image.comp").getHandler()
	});
